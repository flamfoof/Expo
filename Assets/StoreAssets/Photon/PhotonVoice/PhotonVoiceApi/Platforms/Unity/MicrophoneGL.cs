...
namespace Photon.Voice.Unity
{
    ...
    public class MicrophoneGL : UnityEngine.MonoBehaviour
    {
        #region __Internal
        ...
        [DllImport("__Internal")]
        public static extern int GetNumberOfMicrophones();

        [DllImport("__Internal")]
        public static extern string GetMicrophoneDeviceName(int index);

        [DllImport("__Internal")]
        public static extern float GetMicrophoneVolume(int index);

        #endregion

        private const char SEPARATOR = ',';

        private static MicrophoneGL _Instance;
        public static MicrophoneGL Instance
        {
            get
            {
                if (_Instance == null)
                    _Instance = new UnityEngine.GameObject("Microphone").AddComponent<MicrophoneGL>(); // Object should be named as 'Microphone'.
